...
[![Build Status](https://travis-ci.org/AndroidBootstrap/org-dant-beast.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/org-dant-beast)

This repository contains the source code for the [beast](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=org.dant.beast).

Please see the [issues](https://github.org.dant.beast/org-dant-beast/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about beast? Ask away on the [org-dant-beast discussion forum](https://groups.google.com/forum/#!forum/org-dant-beast).

<a href="https://play.google.com/store/apps/details?id=org.dant.beast" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __org.dant.beast__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____org.dant.beast__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.org.dant.beast.R__) will now be renamed
...
signed with a different key.  Manually uninstall beast from your device and
...
beast is a result of a template project I've developed over the years as well as
...
beast is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.org.dant.beast/org-dant-beast/contributors) on
...
[pull requests](https://github.org.dant.beast/org-dant-beast/pulls).
