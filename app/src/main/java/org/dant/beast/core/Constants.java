...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "org.dant.beast";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "beast";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "org.dant.beast.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "org.dant.beast.";
